...
6. `SWARM_PLAN.md`
7. `AGENTS.md`
8. `tasks/manifest.json`
9. `research/BUZZ_PLATFORM_SNAPSHOT.md`
...
Do not ask Dakota to restate known context. Continue using defaults in `OWNER_GATES.md`. At the end, present only the manual actions listed in the final owner packet.
