...
This report is positioning input only. It does not propose courses, certifications, paid memberships, leaderboards, tool directories, news aggregation, or any other item listed in `docs/NON_GOALS.md`. Where a gap suggests future work, it is recorded in `swarm/handoffs/R3.md` under Deferred opportunities.
