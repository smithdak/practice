...
[the locked decisions](../docs/DECISIONS.md) and [the non-goals](../docs/NON_GOALS.md)
...
- [Owner gates](../docs/OWNER_GATES.md) and [owner review packet](../release/OWNER_REVIEW.md)
