...
- Moderation, banning, and content removal remain human-owned decisions
  ([docs/NON_GOALS.md](../../docs/NON_GOALS.md), [docs/DECISIONS.md](../../docs/DECISIONS.md)). Agents triage
  and recommend.
...
| ID | Title | Owned outputs |
|---|---|---|
| W1 | Wire the loop, extend CI, record the phase | `ops/OPERATING_LOOP.md`, `Makefile`, `.github/workflows/ci.yml`, `swarm/manifest.json`, `swarm/reports/PHASE3_REPORT.md` |
