...
> is a governance amendment to `DECISIONS.md` and `NON_GOALS.md`, not a tooling
...
- [Phase 4 plan](../SWARM_PHASE4_PLAN.md) — the task inventory and fixed interfaces.
- [Amendment 001](../community/AMENDMENTS.md) — the governance decision this phase implements.
- [Running Practice on the loop](../ops/AUTONOMOUS_OPERATION.md) — the operating procedure, now including the substrate.
- [Autonomy ladder](../docs/framework/AUTONOMY_LADDER.md) — the levels and the remaining ineligible list.
- Handoffs `X1` through `X6` and `W2` under [`handoffs/`](../handoffs/).
