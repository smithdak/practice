...
[the owner review packet](OWNER_REVIEW.md) remains open, all six method
...
| | T3 | `scripts/release_brief.py` and [the first generated brief](briefs/2026-09-02-phase-2.md) |
...
| W — integration | W1 | [The operating procedure](../ops/AUTONOMOUS_OPERATION.md), the cross-contract tests, CI wiring, and this report |
...
- [Phase 3 plan](../SWARM_PHASE3_PLAN.md) — the task inventory and constraints.
- [Running Practice on the loop](../ops/AUTONOMOUS_OPERATION.md) — the operating
  procedure this phase produced.
- [Owner review packet](OWNER_REVIEW.md) — the gates and holds, all still open.
- Handoffs `S1`, `S2`, `S3`, `T1`, `T2`, `T3`, `T4`, `V1`, and `W1` under
  [`handoffs/`](../handoffs/) — per-task decisions, risks, and deferrals.
