...
**Superseded:** superseded by [FACT_AUDIT_PHASE2.md](FACT_AUDIT_PHASE2.md) (2026-09-01);
current platform facts live in
[buzz/PLATFORM_SNAPSHOT.md](../buzz/PLATFORM_SNAPSHOT.md) as
...
- **Scheduled workflows:** excluded by `docs/DECISIONS.md`, the runbook, the
