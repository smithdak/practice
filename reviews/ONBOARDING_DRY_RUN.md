...
**Location:** `ops/INVITE_FUNNEL.md` (request-route requirement and launch
...
**Severity:** Blocker. **Proposed owner file:** `ops/INVITE_FUNNEL.md`.

### 2. Blocker — launch copy cannot carry a visitor to a real destination

**Location:** `content/launch/SOCIAL_KIT.md` (profile descriptions, launch
...
**Severity:** Blocker. **Proposed owner file:** `content/launch/SOCIAL_KIT.md`.
